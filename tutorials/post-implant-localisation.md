...
See [Configuration](../configuration#mrid-library-file) for details on the `mrid_library.pkl` lookup file this pipeline needs, and [Configuration](../configuration#custom-bent-shank-geometry-optional) if you're localising a flexible bundle-style probe rather than a rigid straight shank.
